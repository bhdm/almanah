...
class RssController extends Controller{
    const ENTITY_NAME = 'Rss';
    /**
     * @Security("has_role('ROLE_ADMIN')")
     * @Route("/", name="admin_rss_list")
     * @Template()
     */
    ...
    public function showAction($id){
        ...
        $feed_to_array = simplexml_load_file(file_get_contents($site->getUrl()));
    ...
    public function addAction(Request $request){
        ...
        $item = new Rss();
        $form = $this->createForm(RssType::class, $item);
        ...
        if ($request->getMethod() == 'POST'){
            if ($formData->isValid()){
                ...
                $em->flush();
                $em->refresh($item);
                return $this->redirect($this->generateUrl('admin_rss_list'));
            }
        }
    ...
    /**
     * @Security("has_role('ROLE_ADMIN')")
     * @Route("/edit/{id}", name="admin_rss_edit")
     * @Template()
     */
    ...
    /**
     * @Security("has_role('ROLE_ADMIN')")
     * @Route("/remove/{id}", name="admin_rss_remove")
     */
