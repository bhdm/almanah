...
class ProfileFormType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('status', ChoiceType::class, array(
            'choices' => array(
                'Интересуюсь сельским хозяйством, фермер(предприниматель в области сельского хозяйства)' => 'Интересуюсь сельским хозяйством, фермер',
                'владелец сельскохозяйственной компании' => 'владелец сельскохозяйственной компании',
                'сотрудник сельскохозяйственной компании' => 'сотрудник сельскохозяйственной компании',
                'студент с/х ВУЗа' => 'студент с/х ВУЗа',
                'сотрудник поставщика/покупателя сельхоз.производителей' => 'сотрудник поставщика/покупателя сельхоз.производителей',
                'другое' => 'другое',
            ),
            'expanded' => true,
            'multiple' => false,
